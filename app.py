...
def home():
    ...
    if request.method == "POST":
        ...
        WishPost(nama,doa)
    return render_template('index.html',receive=receive,male=male,female=female,couple=couple,date=date,pfemale=pfemale,pmale=pmale,day=day,atime=atime,start=start,end=end,nameplace=nameplace,rekening1=rekening1,norekening1=norekening1,rekening=rekening,norekening=norekening)